# This module was derived from the module with the same name in
# https://github.com/dpalmasan/TRUNAJOD2.0 on 13 September 2022
# Only the SPACY model is used: support for the STANZA model was removed

"""Entity grid module for TRUNAJOD (original doc string)
